...
describe("CanvasRender", () => {
  ...
  it("should store lastDrawnFrame and use it if no new frame is provided", () => {
    ...
    expect(scaleToCoverModule.scaleToCover).toHaveBeenCalledWith(frame1, expect.anything(), expect.anything(), expect.anything());
  ...
  it("should use fallback if no frame and no lastDrawnFrame", () => {
    ...
    expect(scaleToCoverModule.scaleToCover).toHaveBeenCalledWith(fallback, expect.anything(), expect.anything(), expect.anything());
  });
